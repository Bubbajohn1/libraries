...
function info:addtext(text)
    local extra = {}
    local new_text = info.object("TextLabel", {
        Parent = objects,
...
local target_text = info:addtext("Target")
local name_text = info:addtext(("name: %s"))
local health_text = info:addtext(("health: %s"))
local armor_text = info:addtext(("armor: %s"))
local flags_text = info:addtext(("flags: %s"))
...
function info:update(target: Player)
    ...
    name_text:settext(("name: %s"):format(target.Name))
    health_text:settext(("health: %s"):format(tostring(target.Character.Humanoid.Health)))
    armor_text:settext(("armor: %s"):format(get_armor(target)))
    flags_text:settext("flags: {}")
end
