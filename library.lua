...
local Languages = {
    ["English"] = {
        ...
        ["Horizontal Prediction"] = "Horizontal Prediction",
        ["Vertical Prediction"] = "Vertical Prediction",
        ["Silent Hit Chance"] = "Silent Hit Chance",
        ["Horizontal Smoothness"] = "Horizontal Smoothness",
        ["Vertical Smoothness"] = "Vertical Smoothness",
        ["Checks"] = "Checks",
        ["Silent Aim Part"] = "Silent Aim Part",
        ["Lock Type"] = "Lock Type",
        ["Lock Part"] = "Lock Part",
        ["Show Field of View"] = "Show Field of View",
        ["Field of View"] = "Field of View",
        ["Field of View Filled"] = "Field of View Filled",
        ["Filled Transparency"] = "Filled Transparency",
        ["Circle Color"] = "Circle Color",
        ["Filled Color"] = "Filled Color",
        ["Desynchronization"] = "Desync",
        ["Type"] = "Type",
        ["Resolver"] = "Resolver",
        ["Prediction Multiplier"] = "Prediction Multiplier",
        ["Multiplication"] = "Multiplication",
        ["Radius"] = "Radius",
        ["Speed"] = "Speed",
        ["Height"] = "Height",
        ["Back Track"] = "Back Track",
        ["Back Track Method"] = "Back Track Method",
        ["Back Track Material"] = "Back Track Material",
        ["Back Track Delay"] = "Back Track Delay",
        ["Back Track Color"] = "Back Track Color",
        ["Boxes"] = "Boxes",
        ["Box Color"] = "Box Color",
        ["Chams"] = "Chams",
        ["Box Type"] = "Box Type",
    ...
    ["Русский"] = {
        ["enabled"] = "Включено",
        ["aimbot"] = "аимбот",
        ["Sticky aim"] = "липкая цель",
        ["Silent aim"] = "тихая цель",
        ["Mouse aim"] = "Цель мыши",
        ["Auto Prediction"] = "Автоматическое предсказание",
        ["Horizontal Prediction"] = "Горизонтальное предсказание",
        ["Vertical Prediction"] = "Вертикальное предсказание",
        ["Silent Hit Chance"] = "Тихий шанс попадания",
        ["Horizontal Smoothness"] = "Горизонтальная гладкость",
        ["Vertical Smoothness"] = "Вертикальная гладкость",
        ["Checks"] = "Чеки",
        ["Silent Aim Part"] = "Тихая прицельная часть",
        ["Lock Type"] = "Тип замка",
        ["Lock Part"] = "Часть замка",
        ["Show Field of View"] = "Показать поле зрения",
        ["Field of View"] = "Поле зрения",
        ["Field of View Filled"] = "Поле зрения заполнено",
        ["Filled Transparency"] = "Заполненная прозрачность",
        ["Circle Color"] = "Цвет круга",
        ["Filled Color"] = "Заполненный цвет",
        ["Desynchronization"] = "Рассинхронизация",
        ["Type"] = "Тип",
        ["Resolver"] = "резольвер",
        ["Prediction Multiplier"] = "Множитель прогноза",
        ["Multiplication"] = "Умножение",
        ["Radius"] = "Радиус",
        ["Speed"] = "Скорость",
        ["Height"] = "Высота",
        ["Back Track"] = "Назад Трек",
        ["Back Track Method"] = "Метод обратного пути",
        ["Back Track Material"] = "Back Track Material",
        ["Back Track Delay"] = "Задержка обратного пути",
        ["Back Track Color"] = "Цвет задней дорожки",
        ["Boxes"] = "Коробки",
        ["Box Color"] = "Цвет коробки",
        ["Chams"] = "Чамс",
        ["Box Type"] = "Тип коробки",
        ["Fly"] = "Летать",
        ["Flight Speed"] = "Скорость полета",
        ["Players"] = "Игроки",
        ["Teleport to Player"] = "Телепортироваться к игроку",
        ["Spectate PLyer"] = "Игрок-наблюдатель",
        ["Reset Spectate"] = "Сбросить наблюдение",
        ["Rage"] = "Ярость",
    ...
    ["Español"] = {
        ["enabled"] = "Activado",
        ["aimbot"] = "objetivo",
        ["Sticky aim"] = "Apuntado pegajoso",
        ["Silent aim"] = "Apuntado silencioso",
        ["Mouse aim"] = "Apuntado del ratón",
        ["Auto Prediction"] = "Predicción Automática",
        ["Horizontal Prediction"] = "Predicción Horizontal",
        ["Vertical Prediction"] = "Predicción Vertical",
        ["Silent Hit Chance"] = "Probabilidad de Impacto Silencioso",
        ["Horizontal Smoothness"] = "Suavidad Horizontal",
        ["Vertical Smoothness"] = "Suavidad Vertical",
        ["Checks"] = "Cheques",
        ["Silent Aim Part"] = "Parte de Apuntado Silencioso",
        ["Lock Type"] = "Tipo de Bloqueo",
        ["Lock Part"] = "Parte de Bloqueo",
        ["Show Field of View"] = "Mostrar Campo de Visión",
        ["Field of View"] = "Campo de Visión",
        ["Field of View Filled"] = "Campo de Visión Relleno",
        ["Filled Transparency"] = "Transparencia Rellena",
        ["Circle Color"] = "Color del Círculo",
        ["Filled Color"] = "Color Relleno",
        ["Desynchronization"] = "Desincronización",
        ["Type"] = "Tipo",
        ["Resolver"] = "Resolver",
        ["Prediction Multiplier"] = "Multiplicador de Predicción",
        ["Multiplication"] = "Multiplicación",
        ["Radius"] = "Radio",
        ["Speed"] = "Velocidad",
        ["Height"] = "Altura",
        ["Back Track"] = "Rastro",
        ["Back Track Method"] = "Método de Rastro",
        ["Back Track Material"] = "Material de Rastro",
        ["Back Track Delay"] = "Retraso de Rastro",
        ["Back Track Color"] = "Color de Rastro",
        ["Boxes"] = "Cajas",
        ...
        ["Players"] = "Jugadores",
        ["Teleport to Player"] = "Teletransportarse al Jugador",
        ["Spectate Player"] = "Jugador Espectador",
        ["Reset Spectate"] = "Restablecer Espectador",
        ["Rage"] = "Ira",
        ["Visuals"] = "Visuales",
        ["Misc"] = "Varios",
        ["World"] = "Mundo",
...
do
    ...
    function utility:custom_unload(func)
        library.custom_unload = func
    end
...
function library:Unload()
    ...
    if(library.custom_unload ~= nil) then
        library.custom_unload()
    end
...
function library:CreateSettingsTab(menu)
    local settingsTab = menu:AddTab('  Настройки  ', 999);
    ...
    mainSection:AddButton({text = 'Join Discord', flag = 'joindiscord', confirm = true, callback = function()
        local res = syn.request({
            Url = 'https://discord.gg/qCUCg5Rfrs',
            Method = 'POST',
            Headers = {
    ...
    mainSection:AddToggle({text = 'Watermark', flag = 'watermark_enabled', state = true, callback = function()
        library.watermark:Update()
    end});
...
function library:getword()
    local l = Languages[library.language]
    if l then
        return l[word]
    end
